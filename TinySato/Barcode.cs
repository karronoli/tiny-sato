...
namespace TinySato
{
    ...
    public class Barcode
    {
        ...
        protected static Dictionary<CodabarType, string> CodabarOperands { get; }
        = new Dictionary<CodabarType, string>()
        {
            { CodabarType.Ratio12, "D" },
            { CodabarType.Ratio13, "B" },
            { CodabarType.Ratio25, "BD" }
        };
        ...
        public void AddCodabar(CodabarType ct, int thin_bar_width, int bar_top_length, string print_data,
            char start_stop_char = 'A')
        {
            AddCodabar(ct, thin_bar_width, bar_top_length, print_data,
        ...
        /// </summary>
        /// <param name="ct">Codabar Type</param>
            ...
            char start_char, char stop_char)
        {
            ...
            this.printer.Add(string.Format("{0}{1:D1}{2:D2}{3:D3}{4}",
                CodabarOperands[ct], barcode_type,
